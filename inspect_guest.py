...
Requires:
  - libguestfs and python3-guestfs
  - sudo apt install libguestfs-tools python3-guestfs  (Ubuntu/Debian)
  - sudo dnf install libguestfs python3-libguestfs    (Fedora/RHEL)
        """
    )
    ...
    parser.add_argument(
        'image',
        type=Path,
        help='Path to disk image (qcow2, raw, vmdk, etc.)'
    )
    ...
    parser.add_argument(
        ...
        dest='network_info',
        action='store_false',
        help='Skip network interface inspection'
    )
    ...
    parser.add_argument(
        ...
        dest='package_info',
        action='store_false',
        help='Skip package inspection (faster)'
    )
    ...
    parser.add_argument(
        ...
        dest='user_info',
        action='store_false',
        help='Skip user account inspection'
    )
    ...
    parser.add_argument(
        ...
        dest='disk_info',
        action='store_false',
        help='Skip disk usage inspection'
    )

    parser.add_argument(
        '--network-only',
        action='store_true',
        help='Only inspect network information'
    )

    parser.add_argument(
        '--verbose', '-v',
        action='store_true',
        help='Show additional verbose information'
    )
    ...
    if not GUESTFS_AVAILABLE:
        print("❌ Error: libguestfs not available")
        print()
        print("Install with:")
        print("  Ubuntu/Debian: sudo apt install libguestfs-tools python3-guestfs")
        print("  Fedora/RHEL:   sudo dnf install libguestfs python3-libguestfs")
        print("  Arch:          sudo pacman -S libguestfs python-libguestfs")
        return 1
