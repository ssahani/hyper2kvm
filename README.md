...
flowchart TB
  ...
  subgraph DP["DATA PLANE (move bytes) 📦⚡"]
    ...
    V2V["virt-v2v (experimental option) 🧪⚗️"]
    RESUME["resume + verify + atomic publish 🔄✅🛡️"]
  end
  CP --> META --> DP
  GOVCEXP --> RESUME
  OVFTOOL --> RESUME
