...
2. **Learn More**
   - [Beginner Tutorial](../tutorials/01-beginner-migration.md) - Detailed walkthrough
   - [Migration Recipes](../recipes/01-common-scenarios.md) - Common patterns
   - [Troubleshooting Guide](../guides/troubleshooting.md) - Fix common issues

3. **Explore Features**
   - [Batch Migration](../guides/migration/batch-features.md) - Migrate multiple VMs
...
→ [Migration Recipes](../recipes/01-common-scenarios.md)
