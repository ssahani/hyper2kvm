...
2. Follow [BUILDING.md](BUILDING.md) to set up development environment
3. See [PUBLISHING.md](PUBLISHING.md) for release procedures

## See Also

- [../95-Testing-Guide.md](../95-Testing-Guide.md) - Testing guidelines
- [../01-Architecture.md](../01-Architecture.md) - System architecture
- [../project/](../project/) - Project status and roadmap
