...
2. **VirtIO drivers ISO** (latest from [Fedora VirtIO](https://fedorapeople.org/groups/virt/virtio-win/))
...
windows:
  ...
  virtio_drivers_path: /opt/virtio-drivers
...
hyper2kvm convert \
  ...
  --virtio-drivers /opt/virtio-drivers \
  --windows-optimize
```
