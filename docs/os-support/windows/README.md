...
**Solutions**:
- **Offline Injection**: Before first boot (requires libguestfs access to Windows registry)
...
### Before Migration
1. ✅ Document source VM configuration (boot mode, disk layout)
2. ✅ Verify Windows license (volume vs retail)
3. ✅ Check for third-party drivers that may need reinstallation
4. ✅ Create checkpoint/snapshot before migration
