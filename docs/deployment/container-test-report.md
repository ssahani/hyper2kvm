...
1. Add `python3-libguestfs` to Dockerfile as optional
2. Create separate image variant without Windows support
3. Document guestfs requirement for Windows guests
