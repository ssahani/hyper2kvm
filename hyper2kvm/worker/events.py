...
class EventStore:
    ...
    def store(self, event: ProgressEvent) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                self.logger.error(f"Failed to persist event for job {event.job_id}: {e}")
    ...
    def _load_from_disk(self, job_id: str) -> List[ProgressEvent]:
        ...
        try:
            ...
            self.logger.error(f"Failed to load events for job {job_id}: {e}")
...
class ProgressTracker:
    ...
    def __init__(
        ...
        self._phase_progress: Dict[str, int] = {phase: 0 for phase in phases}
