...
class JobQueue:
    ...
    def __init__(self, queue_dir: Optional[Path] = None):
        ...
        self._queues: Dict[int, Deque[JobSpec]] = {
            i: deque() for i in range(1, 11)
        }
    ...
    def dequeue(
        self,
        worker_capabilities: Optional[Dict[str, bool]] = None
    ) -> Optional[JobSpec]:
        """
        ...
        with self._lock:
            ...
            for priority in sorted(self._queues.keys()):
                ...
                for i, job_spec in enumerate(queue):
    ...
    def _job_matches_worker(
        self,
        job_spec: JobSpec,
        worker_capabilities: Optional[Dict[str, bool]]
    ) -> bool:
    ...
    def _persist_to_disk(self, job_spec: JobSpec) -> None:
        ...
        try:
            ...
            self.logger.error(f"Failed to persist job {job_spec.job_id}: {e}")
...
class WorkerRegistry:
    ...
    def get_worker(self, worker_id: str) -> Optional[WorkerCapabilities]:
    ...
    def find_capable_worker(
        self,
        requirements: Dict[str, bool]
    ) -> Optional[WorkerCapabilities]:
        """
