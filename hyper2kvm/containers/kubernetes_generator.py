...
class KubernetesManifestGenerator:
    ...
    def generate_deployment(
        ...
        try:
            ...
            self.logger.error(f"Failed to generate Deployment: {e}")
    ...
    def generate_service(
        ...
        try:
            ...
            result["errors"].append(str(e))
            self.logger.error(f"Failed to generate Service: {e}")
    ...
    def generate_configmap(
        ...
        try:
            ...
            result["errors"].append(str(e))
            self.logger.error(f"Failed to generate ConfigMap: {e}")
    ...
    def generate_persistent_volume_claim(
        ...
        try:
            ...
            result["errors"].append(str(e))
            self.logger.error(f"Failed to generate PVC: {e}")
        ...
        if container.volumes:
            ...
            for volume in container.volumes:
                ...
                if vol_name and mount_path:
                    k8s_container["volumeMounts"].append({
                        "name": vol_name,
