...
class ChangeTracker:
    ...
    def track_change(
        ...
        try:
            ...
            self.logger.error(f"Failed to write change record: {e}")

        self.logger.debug(
            f"CHANGE: {change_type.value} | Resource={resource} | "
    ...
    def get_changes(
        ...
        try:
            ...
            self.logger.error(f"Failed to read changes: {e}")
