...
class WindowsUpdateManager:
    ...
    def enable_windows_update(self, g: VMCraft) -> dict[str, Any]:
        ...
        try:
            ...
            audit["error"] = str(e)
            self.logger.error(f"Failed to enable Windows Update: {e}")
    ...
    def stage_virtio_drivers(
        ...
        try:
            ...
            audit["error"] = str(e)
            self.logger.error(f"Failed to stage VirtIO drivers: {e}")
    ...
    def inject_driver_installation_script(
        ...
        try:
            ...
            audit["error"] = str(e)
            self.logger.error(f"Failed to inject driver script: {e}")
