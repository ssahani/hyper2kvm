...
from .state_tracker import StateTracker, MigrationState
from .rollback_executor import RollbackExecutor, RollbackResult
from .rollback_validator import RollbackValidator, ValidationResult
...
class RollbackOrchestrator:
    ...
    def execute_full_rollback(
        ...
        *,
        ...
        self.logger.info(
            f"Rollback complete: {rollback_id} "
            f"(success={report.success}, duration={duration:.2f}ms)"
        )
    ...
    def execute_partial_rollback(
        ...
        *,
        ...
        self.logger.info(
            f"Partial rollback complete: {rollback_id} "
            f"(success={report.success}, duration={duration:.2f}ms)"
        )
