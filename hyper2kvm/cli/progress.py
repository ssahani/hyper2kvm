...
class ProgressTracker:
    ...
    def __init__(self, stages: list[str]):
        ...
        self.stage_progress: dict[str, float] = {stage: 0.0 for stage in stages}
    ...
    def _render(self) -> None:
        ...
        current_stage = self.stages[self.current_stage_idx] if self.current_stage_idx < len(self.stages) else "Done"
        eta = self.get_eta()
