    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                from ..registry.io import _download_hive_local
                ...
                logger.info(
                    f"Balloon driver configured: stats_interval={memory_stats_interval}s, "
                    f"free_page_reporting={enable_free_page_reporting}"
                )
        ...
        try:
            ...
            logger.info(f"Balloon verification script staged at {script_path}")
        ...
        logger.error(f"Failed to configure balloon driver: {e}")
...
def _generate_balloon_verification_script(
    ...
    """
    script = f"""# VirtIO Balloon Driver Verification Script
