...
class CompatibilityReport:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "hardware_dependent_applications": [
                f.to_dict() for f in self.hardware_apps
            ],
            "license_services": [
                f.to_dict() for f in self.license_services
            ],
            "dongle_drivers": [
                f.to_dict() for f in self.dongle_drivers
            ],
            "sql_server_instances": [
                i.to_dict() for i in self.sql_instances
            ],
        }
...
def generate_compatibility_report(
    ...
    logger.info(
        f"Compatibility report generated: {report.total_findings} findings "
